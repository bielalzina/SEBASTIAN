...
async def get_home(request: Request, token: str = None):
    ...
    <body>
        <div class="sidebar">
            ...
            <div class="status">● Sistema segur (WebSocket actiu)</div>
        </div>
        <div class="main">
        ...
        <script>
            ...
            addMsg('Sistema segur activat. Connectat al sistema.', 'bot');
        </script>
    </body>
    </html>
    """
...
async def websocket_endpoint(websocket: WebSocket, token: str = None):
    # Verificació de seguretat en la connexió WS
    if token != settings.WEB_ACCESS_TOKEN:
    ...
    logger.info(f"Nova connexió WebSocket segura: {{session_id}}")
    ...
    try:
        while True:
            ...
            if message.get("type") == "message":
                ...
                logger.info(f"Missatge rebut de {{session_id}}: {{text}}")
                
                # Executem el missatge a través del Gateway
        ...
        logger.error(f"Error crític WebSocket: {{e}}")
